...
def run_timer(context: GUI):
    while True:
        ...
        if game_state.game_state['game']['state'] == 'started':
            ...
            gui_updater.update_gui_turn_time(context, Turn.WHITE)
            gui_updater.update_gui_turn_time(context, Turn.BLACK)
            gui_updater.update_gui_total_time(context, Turn.WHITE)
            gui_updater.update_gui_total_time(context, Turn.BLACK)
